...
var wishlistCountElem = document.getElementById("wishlistCount");
var wishlistCount = 0;

// Render products function with Heart/Like button
function displayProducts(productList) {
    ...
    productList.forEach(function(product) {
        ...
        var heartIcon = productCard.querySelector(".wishlist-icon");
        if (heartIcon) {
            heartIcon.addEventListener("click", function() {
                ...
                if (wishlistCountElem) {
                    wishlistCountElem.textContent = wishlistCount;
                }
            });
        }
